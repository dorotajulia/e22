...
public class Ksiazka {
    ...
    public String getAutorzyString(){
        Iterator<Autor> autorzyIterator = autorzy.iterator();
        String autorzyString = "";
        while(autorzyIterator.hasNext()) {
            Autor temp = autorzyIterator.next();
            autorzyString = autorzyString + temp.getImie() + " " + temp.getNazwisko() + ", ";
        }
        return autorzyString;
    }
    @Override
